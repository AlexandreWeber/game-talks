...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-admin-module"], {
                        ...
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
                                    this.currentQuestion = 0;
                                    _a = this;
                                    return [4 /*yield*/, this.questionsService.getQuestions(type)];
                                case 1:
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var QuestionsService = /** @class */ (function () {
                ...
                QuestionsService.prototype.getQuestions = function (type) {
                    var _this = this;
                    return new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    url = type === 'front' ? 'https://firebasestorage.googleapis.com/v0/b/kahoot-315c5.appspot.com/o/front.json?alt=media&token=f46f6bcf-655d-4494-9357-6068f4d8be07'
                                        : '';
