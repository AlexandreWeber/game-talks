...
const routes = [
    {
        path: 'game',
        loadChildren: () => Promise.all(/*! import() | game-game-module */[__webpack_require__.e("common"), __webpack_require__.e("game-game-module")]).then(__webpack_require__.bind(null, /*! ./game/game.module */ "./src/app/game/game.module.ts")).then(m => m.GameModule)
    },
    {
        path: 'admin',
